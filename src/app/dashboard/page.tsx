...
export default function DashboardPage() {
  ...
  // lock to 90% zoom like browser 90% (user preference)
  React.useEffect(() => {
  ...
  return (
    <div className="flex min-h-[111.11vh] w-full bg-[#f8f8f5] dark:bg-[#070d07]">
      ...
      <aside className="hidden lg:flex w-[300px] shrink-0 flex-col border-r border-[var(--border)] bg-white dark:bg-[#0f1410] sticky top-0 h-[111.11vh]">
        ...
        <div className="flex-1 p-6 lg:p-8 space-y-6 bg-[#f8f8f5] dark:bg-[#070d07] overflow-auto">
          ...
          <div className="rounded-[16px] border border-[var(--border)] bg-white dark:bg-[#1a221a] overflow-hidden shadow-sm">
            <div className="flex items-center justify-between border-b border-[var(--border)] px-6 py-5">
              <h3 className="text-[15px] font-bold text-[var(--text-dark)]">Submissions</h3>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid gap-3">
                <div>
                  ...
                  <input value={displayName} onChange={(e) => setDisplayName(e.target.value)} placeholder="Administrator" className="mt-1.5 w-full rounded-[4px] border border-[var(--border)] bg-white dark:bg-[#1a221a] px-4 py-3 text-[15px] outline-none focus:border-[#4a8c3f] focus:ring-4 focus:ring-[#4a8c3f]/10 transition-all" />
                </div>
                <div>
                  <label className="text-[13px] font-bold uppercase tracking-wide text-[var(--text-light)]">Email address</label>
                  <input value={emailField} onChange={(e) => setEmailField(e.target.value)} placeholder="lead@rich.africa" className="mt-1.5 w-full rounded-[4px] border border-[var(--border)] bg-white dark:bg-[#1a221a] px-4 py-3 text-[15px] outline-none focus:border-[#4a8c3f] focus:ring-4 focus:ring-[#4a8c3f]/10 transition-all" />
                </div>
              </div>
