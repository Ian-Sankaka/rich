      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-16 py-6 sm:py-10">
        <div className="w-full max-w-[560px] animate-[toast-in_0.5s_ease]">
          <div className="relative rounded-[18px] bg-white dark:bg-[#1a221a] border border-transparent dark:border-white/10 px-5 sm:px-8 lg:px-10 py-8 sm:py-10 lg:py-12 shadow-[0_22px_70px_rgba(59,45,36,0.10)] dark:shadow-none">
            ...
            <h1 className="text-center text-[24px] font-bold text-[#1c1c1c] dark:text-white">Create your account</h1>
            <p className="text-center text-[16px] text-[#756b62] dark:text-white/60 mt-1.5 mb-8">Join the RICH knowledge community</p>
            ...
            }} className="flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-[#f0eae4] dark:border-white/10 bg-white dark:bg-white/5 px-5 py-4 text-[15px] font-bold text-[#2f3745] dark:text-white hover:bg-gray-50 dark:hover:bg-white/10 hover:scale-[1.01] transition-all">
